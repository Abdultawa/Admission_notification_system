    ...
    <div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-8">
        ...
        <section class="w-full lg:w-4/5">
            ...
            <div class="md:flex mb-6">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white" id="my-textfield" type="text" name="firstname" value="{{ old('firstname', $application->firstname) }}" required>
                        </div>
                    </div>
                    <div class="md:flex mb-6">
                        <div class="md:w-1/3">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white" id="my-textfield" type="text" name="lastname" value="{{ old('lastname', $application->lastname) }}" required>
                        </div>
                    </div>
                    <div class="md:flex mb-6">
                        <div class="md:w-1/3">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white" id="my-textfield" type="date" name="dob" value="{{ old('dob', $application->dob) }}" required>
                        </div>
                    </div>
                    <div class="md:flex mb-6">
                        <div class="md:w-1/3">
                        ...
                        <div class="md:w-2/3">
                            ...
                            <option value="Male"  {{ old('gender', $application->gender) == $application->gender ? 'selected' : '' }}>Male</option>
                            <option value="Female"  {{ old('gender', $application->gender) == $application->gender ? 'selected' : '' }}>Female</option>
            ...
            <div id='section2' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white" id="my-textfield" type="text" name="phone" value="{{ old('phone', $application->phone) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <select name="country" class="form-input block w-full focus:bg-white">
                            <option value="Nigeria" {{ old('country', $application->country) == $application->country ? 'selected' : '' }}>Nigeria</option>
                            <option value="Foreign Country"  {{ old('country', $application->country) == $application->country ? 'selected' : '' }}>Foreign Country</option>
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white" id="my-textfield" type="text" name="state" value="{{ old('state', $application->state) }}" required>
                        </div>
                    </div>
                    <div class="md:flex mb-6">
                        <div class="md:w-1/3">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white" id="my-textfield" type="text" name="address" value="{{ old('address', $application->address) }}" required>
                        </div>
                    </div>
            ...
            <div class="md:flex mb-6">
                        ...
                        <select name="program_type" class="form-input block w-full focus:bg-white">
                            <option value="Regular" {{ old('program_type', $application->program_type) == $application->program_type ? 'selected' : '' }}>Regular</option>
                            <option value="Evening" {{ old('program_type', $application->program_type) == $application->program_type ? 'selected' : '' }}>Evening</option>
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <select name="dept" class="form-input block w-full focus:bg-white">
                            <option value="Computer Science" {{ old('dept', $application->dept) == $application->dept ? 'selected' : '' }}>Computer Science</option>
                            <option value="Cooperative Economics and Management" {{ old('dept', $application->dept) == $application->dept ? 'selected' : '' }}>Cooperative Economics and Management</option>
                            <option value="Banking and Finance" {{ old('dept', $application->dept) == $application->dept ? 'selected' : '' }}>Banking and Finance</option>
                            <option value="AGRIBUSINESS AND MANAGEMENT" {{ old('dept', $application->dept) == $application->dept ? 'selected' : '' }}>AGRIBUSINESS AND MANAGEMENT</option>
                            <option value="BUSINESS ADMINISTRATION AND MANAGEMENT" {{ old('dept', $application->dept) == $application->dept ? 'selected' : '' }}>BUSINESS ADMINISTRATION AND MANAGEMENT</option>
                            <option value="ACCOUNTANCY" {{ old('dept', $application->dept) == $application->dept ? 'selected' : '' }}>ACCOUNTANCY</option>
                            <option value="HOME AND RURAL ECONOMICS" {{ old('dept', $application->dept) == $application->dept ? 'selected' : '' }}>HOME AND RURAL ECONOMICS</option>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    <label for="primaryCertificate" class="flex-1 mr-4 rounded-md bg-gray-200 px-4 py-2 cursor-pointer hover:bg-gray-300">
                        ...
                        <input id="primaryCertificate" name="primaryCertificate" type="file" class="-hidden" accept=".jpg, .jpeg, .png" value="{{old('primaryCertificate', $application->primaryCertificate)}}">
                    </label>
                    <span class="text-gray-500 text-xs">Supported formats: JPG, JPEG, PNG</span>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    <label for="birthCertificate" class="flex-1 mr-4 rounded-md bg-gray-200 px-4 py-2 cursor-pointer hover:bg-gray-300">
                        ...
                        <span>Choose File</span>
                        <input id="birthCertificate" name="birthCertificate" type="file" class="-hidden" accept=".jpg, .jpeg, .png" value="{{old('birthCertificate', $application->birthCertificate)}}">
                    </label>
                    <span class="text-gray-500 text-xs">Supported formats: JPG, JPEG, PNG</span>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    <label for="olevelCertificate" class="flex-1 mr-4 rounded-md bg-gray-200 px-4 py-2 cursor-pointer hover:bg-gray-300">
                        ...
                        <span>Choose File</span>
                        <input id="olevelCertificate" name="olevelCertificate" type="file" class="-hidden" accept=".jpg, .jpeg, .png" value="{{old('olevelCertificate', $application->olevelCertificate)}}">
                    </label>
                    <span class="text-gray-500 text-xs">Supported formats: JPG, JPEG, PNG</span>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    <label for="indegineCertificate" class="flex-1 mr-4 rounded-md bg-gray-200 px-4 py-2 cursor-pointer hover:bg-gray-300">
                        ...
                        <span>Choose File</span>
                        <input id="indegineCertificate" name="indegineCertificate" type="file" class="-hidden" accept=".jpg, .jpeg, .png" value="{{old('indegineCertificate', $application->indegineCertificate)}}">
                    </label>
                    <span class="text-gray-500 text-xs">Supported formats: JPG, JPEG, PNG</span>
                </div>
            </div>
